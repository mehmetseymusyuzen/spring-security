package com.spring.security.inmemory.security;
...
@Configuration
@EnableWebSecurity // Security Filter Chain aktif etmemizi saglar
@EnableMethodSecurity // Controller sinifini verecek olursak onlarin guvenligini saglar
